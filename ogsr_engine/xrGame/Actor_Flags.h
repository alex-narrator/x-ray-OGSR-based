...
enum{
	...
	AF_INVENTORY_VOLUME			= 1<<15,
	AF_PICKUP_TARGET_ONLY		= 1<<16,
	AF_ARTEFACTS_FROM_ALL		= 1<<17,
	AF_ARTEFACT_DETECTOR_CHECK	= 1<<18,
	AF_KNIFE_TO_CUT_PART		= 1<<21,
	AF_AI_VOLUMETRIC_LIGHTS		= 1<<22,
	AF_BLOODMARKS_ON_DYNAMIC	= 1<<23,
};
